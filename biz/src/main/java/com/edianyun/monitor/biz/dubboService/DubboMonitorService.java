...
import com.edianyun.monitor.bean.UUIDGenerator;
import com.edianyun.monitor.bean.bizBean.HostBO;
import com.edianyun.monitor.bean.entity.InvokeDO;
import com.edianyun.monitor.biz.support.service.HostService;
import com.edianyun.monitor.common.tools.TimeUtil;
import com.edianyun.monitor.dao.mapper.InvokeDOMapper;
import com.edianyun.monitor.dao.redisManager.InvokeRedisManager;
...
public class DubboMonitorService implements MonitorService {
    ...
    private static final ThreadPoolExecutor POOL = new ThreadPoolExecutor(5,10,600000,TimeUnit.MILLISECONDS,new LinkedBlockingQueue<>(100),new NamedThreadFactory("dubbo-"));
